                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header catego-item" id="<?php echo e($headerId); ?>">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        data-bs-toggle="collapse" data-bs-target="#<?php echo e($accordionId); ?>" aria-expanded="true"
                    ...
                    <div class="catego-sidebar">
                        ...
                        <div class="accordion" id="accordionCategoSidebar">
                            <?php $__currentLoopData = $cats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                ?>
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="<?php echo e($headerId); ?>">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#<?php echo e($accordionId); ?>" aria-expanded="false"
                                            aria-controls="<?php echo e($accordionId); ?>">
                                            <img src="https://tendaxe.com/img/icons/two_hands.png" class="catego-icon"
                                                alt="Category Icon">
                                            <?php echo e($category->name); ?>
                                        ...
                                        <div class="accordion-body">
                                            <ul class="list-unstyled sub-catego-list">
                                                <?php $__currentLoopData = $category->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <li>
                                                        <a href="<?php echo e(route('category.products', $child->id)); ?>"
                                                            class="sub-catego-link"><?php echo e($child->name); ?></a>
                                                    </li>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </ul>
                                        </div>
                ...
                <div class="col-12 col-lg-9">
                    ...
                    <div class="store-catego-products-grid">
                        ...
                        <nav class="breadcrumb-nav" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="<?php echo e(url('/store')); ?>">Store</a></li>
