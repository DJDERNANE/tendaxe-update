<?php $__env->startSection('title', 'Aide'); ?>
    
<?php $__env->startSection('content'); ?>
    <div class="container-fluid px-md-5 py-5" style="background: url(<?php echo e(asset('img/banner/laptop_showing.jpg')); ?>) no-repeat center center; margin-top: 66px; background-size: cover;">
      <div class="">
    ...
    <div class="container main">
      ...
      <div class="ml-2">
        ...
        <div class="d-flex flex-md-row flex-column align-items-center justify-content-around my-5">
          <img class="img-fluid my-2" src="<?php echo e(asset('img/logos/boasem.png')); ?>" alt="">
          <img class="img-fluid my-2" src="<?php echo e(asset('img/logos/bomop.png')); ?>" alt="">
          <img class="img-fluid my-2" src="<?php echo e(asset('img/logos/presse.png')); ?>" alt="">
          <img class="img-fluid my-2" src="<?php echo e(asset('img/logos/websites.png')); ?>" alt="">
        </div>
...
<?php endif; ?>
      ...
      <div class="row my-5">
        <div class="col-4 px-1">
          <a href="<?php echo e(route('docs')); ?>" class="btn btn-primary h-100 w-100 d-flex align-items-center justify-content-center">Documents utiles</a>
        </div>
        <div class="col-4 px-1">
          <a href="<?php echo e(route('conditions')); ?>" class="btn btn-primary h-100 w-100 d-flex align-items-center justify-content-center">Conditions générales d'utilisation</a>
        </div>
        <div class="col-4 px-1">
      ...
      <section id="acheteurs" class="" style="margin-top: 30vh; margin-bottom: 20vh;">
        ...
        <div class="text-center my-5">
          <img class="img-fluid" src="<?php echo e(asset('img/acheteurs/1.png')); ?>" alt="">
        </div>
        <div class="row justify-content-center hide-md my-4">
        <?php for($i = 2; $i <= 8; $i++): ?>
          <div class="col text-center">
            <img class="img-fluid" src="<?php echo e(asset('img/acheteurs/'.$i.'.png')); ?>" alt="">
          </div>
        <?php endfor; ?>
        </div>
        <div class="row justify-content-center hide-md my-4">
          ...
          <?php endfor; ?>
			...
			<div class="row show-md justify-content-center">
				<div class="col-3 text-center">
					<img class="img-fluid" src="<?php echo e(asset('img/acheteurs/9.png')); ?>" alt="">
				</div>
				<div class="col-3 text-center">
					<img class="img-fluid" src="<?php echo e(asset('img/acheteurs/14.png')); ?>" alt="">
				</div>
				
			</div>
			<div class="row show-md">
				<div class="col-3 my-3 text-center">
					<img class="img-fluid" src="<?php echo e(asset('img/acheteurs/4.png')); ?>" alt="">
				</div>
				<div class="col-3 my-3 text-center">
					<img class="img-fluid" src="<?php echo e(asset('img/acheteurs/5.png')); ?>" alt="">
				</div>
				<div class="col-3 my-3 text-center">
					<img class="img-fluid" src="<?php echo e(asset('img/acheteurs/6.png')); ?>" alt="">
				</div>
				<div class="col-3 my-3 text-center">
					<img class="img-fluid" src="<?php echo e(asset('img/acheteurs/7.png')); ?>" alt="">
				</div>
				<div class="col-3 my-3 text-center">
					<img class="img-fluid" src="<?php echo e(asset('img/acheteurs/8.png')); ?>" alt="">
				</div>
				<div class="col-3 my-3 text-center">
					<img class="img-fluid" src="<?php echo e(asset('img/acheteurs/2.png')); ?>" alt="">
				</div>
				<div class="col-3 my-3 text-center">
					<img class="img-fluid" src="<?php echo e(asset('img/acheteurs/10.png')); ?>" alt="">
				</div>
				<div class="col-3 my-3 text-center">
					<img class="img-fluid" src="<?php echo e(asset('img/acheteurs/11.png')); ?>" alt="">
				</div>
				<div class="col-3 my-3 text-center">
					<img class="img-fluid" src="<?php echo e(asset('img/acheteurs/3.png')); ?>" alt="">
				</div>
				<div class="col-3 my-3 text-center">
					<img class="img-fluid" src="<?php echo e(asset('img/acheteurs/15.png')); ?>" alt="">
				</div>
				<div class="col-3 my-3 text-center">
					<img class="img-fluid" src="<?php echo e(asset('img/acheteurs/12.png')); ?>" alt="">
				</div>
				<div class="col-3 my-3 text-center">
					<img class="img-fluid" src="<?php echo e(asset('img/acheteurs/13.png')); ?>" alt="">
				</div>
...
<?php echo $__env->make('layouts.storelayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tendaxe\resources\views/help.blade.php ENDPATH**/ ?>