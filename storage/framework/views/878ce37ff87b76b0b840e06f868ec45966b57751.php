...
<?php $__env->startSection('styling'); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/uploadDocument.css')); ?>">
 <!-- custom css -->
        ...
        <section class="upload-document">
            <div class="container">
                ...
                <div class="upload-document-wrapper">
                    <form action="<?php echo e(route('specifications.newdoc')); ?>" method="POST" class="document-form" id="documentForm" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div id="fileInfos">
...
<?php echo $__env->make('layouts.storelayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tendaxe\resources\views/documents/upload.blade.php ENDPATH**/ ?>