...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container my-5 pt-5">
        <div class="d-flex">
            ...
            <h6><a href="<?php echo e(route('stores.accepted')); ?>" class="active me-2">active</a> </h6>
            <h6><a href="<?php echo e(route('stores.pending')); ?>" class=" ms-2">en attente</a> </h6>
            
        </div>

        <div class="d-flex justify-content-between align-items-center my-4 p-2 bg-white rounded-3 shadow ">
            <div class="pl-5 py-1 pr-2 m-0 d-flex justify-content-between align-items-center store-navbar ">
                <form action="<?php echo e(route('stores.accepted')); ?>" method="GET" class="d-flex bg-light store-form align-items-center p-2 rounded-3 text-black">
                    <?php echo csrf_field(); ?>
            ...
            <tbody>
                <?php $__currentLoopData = $stores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td>
                                <a href="<?php echo e(route('store.block',$item->id)); ?>">
...
<?php echo $__env->make('layouts.adminStorePanel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tendaxe\resources\views/admin/store/acceptedStores.blade.php ENDPATH**/ ?>