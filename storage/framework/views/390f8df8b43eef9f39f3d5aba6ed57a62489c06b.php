...
<div class="container my-5 pt-5">
    ...
    <div class="d-flex justify-content-between align-items-center my-4 p-2 bg-white rounded-3 shadow">
        <div class="pl-5 py-1 pr-2 m-0 d-flex justify-content-between align-items-center store-navbar text-white">
            <form method="GET" action=""<?php echo e(route('brands.all')); ?>" class="d-flex bg-light store-form align-items-center p-2 rounded-3">
                <?php echo csrf_field(); ?>
    ...
    <table class="table text-center">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="<?php echo e(route('brands.edit', $item->id)); ?>" target="_blank">
