...
<?php $__env->startSection('content'); ?>
    ...
    <div class="bg-white p-4 rounded">
        <form class="row d-flex align-items-center" action="<?php echo e(route('admin.users')); ?>" method="GET">
            <div class="col-md-2 ">
                <p class="mb-0">keywords : </p>
                <input class="form-control" type="text" placeholder="search" name="keyword" value="<?php echo e(old('keyword')); ?>">
            </div>
            <div class="col-md-9 d-felx d-flex align-items-end">
                <div class="me-1" >
                    <p class="mb-0">user type : </p>
                    <select class=" form-control" name="type_user" id="">
                        <option value="all" selected>tout</option>
                        <option value="abonné" <?php echo e((old('type_user') === 'abonné') ? 'selected' : ''); ?>>abonné</option>
                        <option value="content" <?php echo e((old('type_user') === 'content') ? 'selected' : ''); ?>>representant</option>
                    </select>
                </div>
                <div class="me-1" >
                    <p class="mb-0">wilaya: </p>
                    <select class=" form-control" name="wilaya_user" id="">
                        <option value="all" selected>Wilaya</option>
                       ...
                       <option value="<?php echo e($wilaya); ?>" <?php echo e((old('wilaya_user') === $wilaya) ? 'selected' : ''); ?>><?php echo e($wilaya); ?></option>
                       <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div class="me-1" >
                    <p class="mb-0">abonnement: </p>
                    <select class=" form-control" name="abonnement" id="">
                        <option value="all" selected>all</option>
                        <option value="free_active" <?php echo e((old('abonnement') === 'free_active') ? 'selected' : ''); ?>>free_active</option>
                        <option value="free_past" <?php echo e((old('abonnement') === 'free_past') ? 'selected' : ''); ?> >free_past</option>
                        <option value="abnm_active"  <?php echo e((old('abonnement') === 'abnm_active') ? 'selected' : ''); ?>>abnm_active</option>
                        <option value="abnm_past" <?php echo e((old('abonnement') === 'abnm_past') ? 'selected' : ''); ?>>abnm_past</option>
                    </select>
                </div>
                <div class="col-md-3">
                    <div class="me-1">
                        <p class="mb-0">start date:</p>
                        <input class="form-control" type="date" name="start_date" value="<?php echo e(old('start_date')); ?>" placeholder="dd/mm/yyyy">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="me-1">
                        <p class="mb-0">end date:</p>
                        <input class="form-control" type="date" name="end_date" value="<?php echo e(old('end_date')); ?>" placeholder="dd/mm/yyyy">
                    </div>
                </div>
        ...
        <table class="table table-striped table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo e(($user->current_abonnement) ? $user->current_abonnement->date_fin : ''); ?></td>
                    ...
                    <td>
                        ...
                        <?php if($user->abonnement_latest[0]->nom_abonnement == 'gratuit' && $isPast &&  $user->abonnement_payant->count() == 0): ?>
                        ...
                        <?php if($user->abonnement_latest[0]->nom_abonnement != 'gratuit' && $isPast): ?>
                            <svg id="SvgjsSvg1096" width="20" height="20" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs"><defs id="SvgjsDefs1097"></defs><g id="SvgjsG1098"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 14" width="20" height="20"><path fill="none" fill-rule="evenodd" stroke="#ff0606" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 1 1 13M1 1l12 12" class="colorStroke000 svgStroke"></path></svg></g></svg>                        <?php endif; ?>
                        <?php if($user->abonnement_latest[0]->nom_abonnement != 'gratuit' && !$isPast): ?>   
...
<?php echo $__env->make('layouts.panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tendaxe\resources\views/admin/users.blade.php ENDPATH**/ ?>