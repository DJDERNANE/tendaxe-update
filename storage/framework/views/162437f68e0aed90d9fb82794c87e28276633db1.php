...
<?php $__env->startSection('title', 'Temoignages'); ?>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Ajouter une Temoignage</h5>
                            </div>
                            <div class="modal-body">
                                <form class="  store-form align-items-center p-2 rounded-3" method="post"
                                    action="<?php echo e(route('testimonials.store')); ?>" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
            ...
            <tbody>
                <?php $__currentLoopData = $testimonials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td>
                            <img src="<?php echo e(asset('pictures/Testimonials/' . $item->picture)); ?>" alt="image" width="50">
                        </td>
                        <td>
        ...
        suppBtn.addEventListener('click', function(event) {
            ...
            if (confirm('Are you sure you want to delete this item?')) {
                ...
                const selectedValues = Array.from(items)
                    ...
                    .map(item => item.value);
                $.ajax({
                    url: '/admin/store/testimonials/delete',
                    type: 'DELETE',
                    data: JSON.stringify({
                        ids: selectedValues,
...
<?php echo $__env->make('layouts.adminStorePanel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tendaxe\resources\views/admin/store/testimonials.blade.php ENDPATH**/ ?>