            ...
            <div class="row">
                                                ...
                                                <?php $__currentLoopData = $category->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <li>
                                                        <a href="<?php echo e(route('category.childs', $item->id)); ?>"
                                                            class="sub-catego-link"><?php echo e($item->name); ?></a>
                                                    </li>
                ...
                <div class="col-12 col-lg-9">
                    ...
                    <div class="store-catego-products-grid">
                        ...
                        <div class="row row-cols-2 row-cols-md-4 row-cols-xl-5 products-grid">
                                    ...
                                    <div class="card product-box">
                                        ...
                                        <a href="<?php echo e(route('store.product.details', $product->id)); ?>">
                                            <img class="mx-auto py-2"
                                                src="<?php echo e(asset('pictures/Products/' . $product->picture)); ?>"
                                                alt="Card image cap">
                                        </a>
                                        <div class="p-2 desc">
                                            <a href="<?php echo e(route('store.product.details', $product->id)); ?>">
                                            ...
                                            <p class="marque">
                                                <span>Marque : </span>
                                                <a href=""
                                                    class="marque-link"><?php echo e($product->brand->name ?? ''); ?></a>
                                            </p>
            ...
            <div class="row py-4 flex-row flex-md-column-reverse flex-lg-row">
                <div class="col-12 col-md-12 col-lg-8">
                    <form class="bg-white border px-4 pt-3 rounded" method="POST"
                        action="<?php echo e(route('facteurProforma.store')); ?>" enctype="multipart/form-data">
    ...
    <section class="popular-products">
        <div class="container">
            ...
            <div class="row row-cols-2 row-cols-md-4 row-cols-lg-5 row-cols-xl-6">
                <?php $__currentLoopData = $productsPub; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col">
                        <div class="card product-box">
                                ...
                                <form class="" method="post" action="<?php echo e(route('cart.store')); ?>">
                                    ...
                                    <div class="qte-products">
                                        ...
                                        <div class="qte-products-control">
                                            ...
                                            <input class="text-center" id="qty-<?php echo e($item->id); ?>" min="1" value="1" type="number" name="qte">
                                            <button type="button" class="text-center" onclick="changeQty(this, 1)">+</button>
                                        </div>
                                    </div>
                                    <div class="add-to-cart">
