...
@section('content')
        ...
        <div class="container mx-auto">
            <div class="text-white header-content">
                ...
                <div class="btns">
                    ...
                    <a href="{{ route('search') }}" class="d-flex align-items-center text-center">
                    ...
                    <a href="{{ route('store') }}" class="d-flex align-items-center text-center">
                        <div class="bg-white d-flex align-items-center justify-content-center">
                            TENDAXE <br> STORE
                        </div>
                        <div class="bg-primary p-2 d-flex align-items-center">
        ...
        <div class="container">
            <div class="row mx-0">
                ...
                <div class="col-md-4 d-flex align-items-center justify-content-center my-2">
                    <img class="img-fluid" src="{{ asset('img/tendaxe-features.png') }}">
                </div>
                <div class="col-md-4 px-md-0">
                    <div class="mb-3">
                        <div class="d-flex align-items-center">
            ...
            <div class="d-flex flex-column align-items-center">
                ...
                <div class="my-5 tendax-store-section">
                    ...
                    <div class="container my-4">
                        ...
                        <div class="my-4">
                            <p>
                                <img src="{{ asset('img/icons/start.png') }}" alt="image" class="mr-2"> Soyez guidés
                                par
                                nos experts
                            </p>
                            <p>
                                <img src="{{ asset('img/icons/annaux.png') }}" alt="image" class="mr-2"> Pour
                                toutes
                                les
                                organismes
                            </p>
                            <p>
                                <img src="{{ asset('img/icons/24.png') }}" alt="image" class="mr-2">
                                Devis en 24 heurs
                            </p>
                            <p>
                                <img src="{{ asset('img/icons/card.png') }}" alt="image" class="mr-2"> Commandez
                                vos
                                articles
                            </p>
                        ...
                        <div class="swiper-slide">
                            <a href="{{ route('category.products', $item->id) }}">
                                <div class="box-catego">
                                    <img src="{{ asset($item->picture ? 'pictures/Category/' . $item->picture : 'pictures/Category/default.webp') }}"
                                        alt="category">
            ...
            <div class="row py-4 flex-row flex-md-column-reverse flex-lg-row">
                <div class="col-12 col-md-12 col-lg-8">
                    <form class="bg-white border px-4 pt-3 rounded" method="POST"
                        action="{{ route('facteurProforma.store') }}" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="_token" value="46tVeOiUpJB8tkpZ4GWApD8CqAgQOKmlArHuS6iA">
                        <div class="row">
    ...
    <section id="latest" class="last-advertisements my-5">
        <div class="container">
            ...
            <div class="text-right">
                <a href="{{ route('search') }}" class="btn btn-primary font-weight-600">Tous les appels
                    d’offre <img class="pl-4" src="{{ asset('img/icons/arrow.png') }}"></a>
            </div>
        </div>
            ...
            <div class="row row-cols-2 row-cols-md-3 row-cols-lg-5 justify-content-center">
                <div class="col text-center px-4 my-2">
                    <div class="bg-white stat-box p-3 border h-100">
                        <img class="img-fluid mx-auto my-3" src="{{ asset('img/stat-products-icon.png') }}">
    ...
    <section class="popular-products">
        <div class="container">
            ...
            <a href="{{ route('allproducts') }}" class="view-more">
                <span>voir plus</span>
    ...
    <section class="create-store">
        <div class="container">
            ...
            <p class=" text-center mb-3 mx-auto">
                En tant que Distributeur Digital et marketplace B2B TendAxe, vousproposez d'avoir une boutique en ligne avec
                une
                ...
                <div class="swiper-wrapper m-4 mx-auto">
                    @foreach ($partners as $item)
                        <div class="swiper-slide text-center">
                            <a href="">
                                <img src="{{ asset('pictures/Partners/' . $item->picture) }}" alt="marque">
                            </a>
                        </div>
                    @endforeach
                            ...
                            <div class="testimonial-box">
                                ...
                                <div class="testimonial-profil-icon-wrapper">
                                    <div class="testimonial-profil-box">
                                        <img src="{{ asset('pictures/Testimonials/' . $item->picture) }}"
                                    ...
                                    <img src="{{ asset('img/testimenial-icon.png') }}" alt=""
        ...
        <div class="container">
            <div class="contact-us-wrapper">
                <div class="contact-desc">
                    ...
                    <a href="{{ route('contact.create') }}" class="contact-link"><i
