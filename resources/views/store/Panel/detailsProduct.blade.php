...
@section('content')
    <div class="bg-white rounded-3 container my-5 pt-5  p-4 ">
        <h3>Edit Produit</h3>
                ...
                <div class="col-4">
                    <div class="col-12">
                        <div class="my-3">
                            ...
                            <img width="200" height="100" class=" my-2" src="{{ asset('pictures/Products/'.$product->picture) }}" alt="photo">
                            <input type="file" name="picture">
                        </div>
                        <div>
                            <label for="">Gallery : </label> <br>
                            @foreach ($product->pictures as $item)
                            <img width="80" height="80" class=" m-2" src="{{ asset('pictures/Products/pictures/'.$product->picture.'/'.$item->path) }}" alt="photo">
                            @endforeach
