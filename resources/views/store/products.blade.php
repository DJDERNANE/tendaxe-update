                                    ...
                                    <div class="card product-box">
                                        ...
                                        <a href="{{ route('store.product.details', $product->id) }}">
                                            <img class="mx-auto py-2"
                                                src="{{ asset('pictures/Products/' . $product->picture) }}"
                                                alt="Card image cap">
                                        </a>
                                        <div class="p-2 desc">
                                            <a href="{{ route('store.product.details', $product->id) }}">
                                            ...
                                            <p class="marque">
                                                <span>Marque : </span>
                                                <a href=""
                                                    class="marque-link">{{ $product->brand->name ?? '' }}</a>
                                            </p>
                                ...
                                <form class="" method="post" action="{{ route('cart.store') }}">
                                    ...
                                    <div class="qte-products">
                                        ...
                                        <div class="qte-products-control">
                                            ...
                                            <input class="text-center" id="qty-{{ $item->id }}" min="1" value="1" type="number" name="qte">
                                            <button type="button" class="text-center" onclick="changeQty(this, 1)">+</button>
                                        </div>
                                    </div>
                                    <div class="add-to-cart">
