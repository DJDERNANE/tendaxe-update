    ...
    <div class="container my-5 pt-5">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class="  store-form align-items-center p-2 rounded-3" method="post" action="{{route('pubs.store')}}"
        ...
        <div class="d-flex justify-content-between align-items-center my-4 p-2 bg-white rounded-3 shadow">
            ...
            <div class="d-flex col-5">
                <form action="{{ route('pubs.filter') }}" method="post"
        ...
        <table class="table table-striped">
            ...
            <tbody>
                @foreach ($pubs as $pub)
                    <tr>
                        <td>
                            <input type="checkbox" name="item[]" value="{{ $pub->id }}">
                        </td>
                        <td>{{ $pub->id }}</td>
                        <td>{{ $pub->zone }}</td>
                        <td>
                            <img src="{{ asset('pictures/Pubs/' . $pub->picture) }}" alt="pub image" width="50">
                        </td>
