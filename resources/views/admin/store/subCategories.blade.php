    ...
    <div class="container my-5 pt-5">
        <div  class="d-flex justify-content-between align-items-center">
            <div class="d-flex">
                ...
                <h6><a href="{{ route('subcategories.all') }}" class="active me-2">SubCategories <span id="count2"></span></a> </h6>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form  class="  store-form align-items-center p-2 rounded-3" method="post" action="{{route('subcategories.store')}}" enctype="multipart/form-data">
                                    @csrf
