...
@section('content')
    ...
    <div class="container my-5 pt-5">
        <div class="d-flex">
            ...
            <h6><a href="{{route('stores.accepted')}}" class="active me-2">active</a> </h6>
            <h6><a href="{{route('stores.pending')}}" class=" ms-2">en attente</a> </h6>
        ...
        <div class="d-flex justify-content-between align-items-center my-4 p-2 bg-white rounded-3 shadow ">
            <div class="pl-5 py-1 pr-2 m-0 d-flex justify-content-between align-items-center store-navbar ">
                <form action="{{route('stores.accepted')}}" method="GET" class="d-flex bg-light store-form align-items-center p-2 rounded-3 text-black">
                    @csrf
            ...
            <tbody>
                @foreach ($stores as $item)
                    <tr>
                        ...
                        <td>
                                <a href="{{route('store.block',$item->id)}}">
