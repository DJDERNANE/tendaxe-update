...
@section('content')
    ...
    <div class="bg-white p-4 rounded">
        <form class="row d-flex align-items-center" action="{{ route('admin.users') }}" method="GET">
            <div class="col-md-2 ">
            ...
            <div class="col-md-9 d-felx d-flex align-items-end">
                ...
                <div class="me-1" >
                    ...
                    <select class=" form-control" name="wilaya_user" id="">
                       ...
                       <option value="{{$wilaya}}" {{ (old('wilaya_user') === $wilaya) ? 'selected' : '' }}>{{$wilaya}}</option>
                       @endforeach
                    </select>
                </div>
                <div class="me-1" >
                    ...
                    <select class=" form-control" name="abonnement" id="">
                        ...
                        <option value="free_active" {{ (old('abonnement') === 'free_active') ? 'selected' : '' }}>free_active</option>
                        <option value="free_past" {{ (old('abonnement') === 'free_past') ? 'selected' : '' }} >free_past</option>
                        <option value="abnm_active"  {{ (old('abonnement') === 'abnm_active') ? 'selected' : '' }}>abnm_active</option>
                        <option value="abnm_past" {{ (old('abonnement') === 'abnm_past') ? 'selected' : '' }}>abnm_past</option>
                    </select>
                </div>
                <div class="col-md-3">
                    <div class="me-1">
                        <p class="mb-0">start date:</p>
                        <input class="form-control" type="date" name="start_date" value="{{ old('start_date') }}" placeholder="dd/mm/yyyy">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="me-1">
                        <p class="mb-0">end date:</p>
                        <input class="form-control" type="date" name="end_date" value="{{ old('end_date') }}" placeholder="dd/mm/yyyy">
                    </div>
                </div>
