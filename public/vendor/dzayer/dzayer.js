...
var wilayas = [
    ...
    {id:"49", name:"Timimoun", lname:" Timimoun",lat:0.00,long:0.00},
    {id:"50", name:"Bordj Badji Mokhtar", lname:" Bordj Badji Mokhtar",lat:0.00,long:0.00},
    {id:"51", name:"Ouled Djellal", lname:" Ouled Djellal",lat:0.00,long:0.00},
    {id:"52", name:"Béni Abbès", lname:" Béni Abbès",lat:0.00,long:0.00},
    {id:"53", name:"In Salah", lname:" In Salah",lat:0.00,long:0.00},
    {id:"54", name:"In Guezzam", lname:" In Guezzam",lat:0.00,long:0.00},
    {id:"55", name:"Touggourt", lname:" Touggourt",lat:0.00,long:0.00},
    {id:"56", name:"Djanet", lname:" Djanet",lat:0.00,long:0.00},
    {id:"57", name:"El M’Ghaier", lname:" El M’Ghaier",lat:0.00,long:0.00},
    {id:"58", name:"El Meniaa", lname:" El Meniaa",lat:0.00,long:0.00},
    ] ;
   ...
   {zip:"0001", name:"Timimoun",wilaya:49 },
   ...
   {zip:"0801", name:"Béni Abbès",wilaya:52 },
   {zip:"0801", name:"Ouled Djellal",wilaya:51 },
   {zip:"0801", name:"Bordj Badji Mokhtar",wilaya:50 },
   ...
   {zip:"0001", name:"Djanet",wilaya:56 },
  ...
  {zip:"4409", name:"Ben Allal",wilaya:44 },
   ...
   function wilaya1(ab) {
        ...
        for (var i = 0; i < wilayas.length; i++) {
           ...
           outp +=  '<option data-id="'+wilayas[i].id+'" value="'+wilayas[i].name+'" >'+wilayas[i].id+"-"+wilayas[i].name+'</option>';
          }
        }
        // document.querySelector(".wil1").innerHTML = outp;
        var x = document.querySelectorAll(".wil1");
        var i;
